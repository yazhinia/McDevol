...
PYBIND11_MODULE(bayesian_distance, m) {
//Init gamma precalc
//calc_precalc<float>();
...
m.def("compute_readcountdist", &compute_readcountdist, "compute distance between contigs using read counts", py::arg("query_index"), py::arg("read_counts"), py::arg("R_c"), py::arg("alpha_sum"), py::arg("alpha"), py::arg("q_read"));
